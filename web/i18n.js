...
export const TRANSLATIONS = {
  "en-US": {
    ...
    "lease.description": "Calculated from maintained border-specific final prices.",
    ...
    "admin.error.finalPriceNonNegative": "Final price must be non-negative.",
  },
  "zh-CN": {
    "app.title": "境外段成本查询",
    "app.eyebrow": "Rail Cost Desk",
    ...
    "lease.description": "按维护的口岸专属最终价计算。",
    "lease.border": "换装口岸",
    "lease.pickup": "提箱地",
    ...
    "admin.error.finalPriceNonNegative": "最终价不能小于 0。",
  },
};
