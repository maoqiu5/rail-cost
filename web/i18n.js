...
export const TRANSLATIONS = {
  "en-US": {
    ...
    "app.loadError": "Data failed to load. Please refresh and try again.",
    "nav.query": "Query",
    "nav.admin": "Data Maintenance",
    ...
    "rule.rail.ownershipQuote": "Uses maintained ownership-specific quote",
    "rule.rail.maintained": "Uses maintained rail freight final price",
    ...
    "rule.lease.maintained": "Uses the maintained border-specific displayed price.",
    "admin.title": "Data Maintenance",
    "admin.empty": "No rows yet.",
    ...
    "admin.error.load": "Unable to load maintenance data.",
    "admin.error.save": "Unable to save this row.",
    "admin.error.delete": "Unable to delete this row.",
    "admin.sections.referenceData": "Reference Data",
    "admin.sections.priceMaintenance": "Price Maintenance",
    "admin.sections.uncategorized": "Other",
    "admin.resources.borders": "Borders",
    "admin.resources.destinations": "Destination stations",
    "admin.resources.railPublicQuotes": "Rail public quotes",
    "admin.resources.railRules": "Rail rules",
    "admin.resources.freightPrices": "Rail freight prices",
    "admin.resources.leasePickups": "Lease pickups",
    "admin.resources.leasePrices": "Lease prices",
    "admin.resources.leaseRules": "Lease rules",
    "admin.fields.id": "ID",
    "admin.fields.code": "Code",
    "admin.fields.nameCn": "Chinese name",
    "admin.fields.nameEn": "English name",
    "admin.fields.sortOrder": "Sort",
    "admin.fields.enabled": "Enabled",
    "admin.fields.stationCode": "Station code",
    "admin.fields.borderCode": "Border code",
    "admin.fields.destinationStationCode": "Destination station code",
    "admin.fields.containerSize": "Container size",
    "admin.fields.socPriceUsd": "SOC final USD",
    "admin.fields.cocPriceUsd": "COC final USD",
    "admin.fields.quoteUsd": "Quote USD",
    "admin.fields.ownership": "Ownership",
    "admin.fields.ruleType": "Rule type",
    "admin.fields.adjustmentUsd": "Adjustment USD",
    "admin.fields.fixedUsd": "Fixed USD",
    "admin.fields.ruleKey": "UI message key",
    "admin.fields.priority": "Priority",
    "admin.fields.note": "Note",
    "admin.fields.pickupCode": "Pickup code",
    "admin.fields.priceUsd": "Table price USD",
    "admin.fields.discountUsd": "Discount USD",
    "admin.fields.displayPriceUsd": "Displayed price USD",
    "admin.error.leasePriceFormula": "Discount and displayed price must be non-negative and satisfy displayed price = table price - discount.",
  },
  "zh-CN": {
    "app.title": "境外段成本查询",
    "app.eyebrow": "Rail Cost Desk",
    "app.loadError": "数据加载失败，请刷新后重试。",
    "nav.query": "查询",
    "nav.admin": "数据维护",
    ...
    "rule.rail.ownershipQuote": "按已维护的箱属专属报价",
    "rule.rail.maintained": "按维护的铁路运费最终价",
    ...
    "rule.lease.maintained": "按维护的口岸专属最终显示价。",
    "admin.title": "数据维护",
    "admin.empty": "暂无数据。",
    "admin.actions": "操作",
    "admin.new": "新增行",
    ...
    "admin.saved": "已保存",
    "admin.deleted": "已删除",
    "admin.confirmDelete": "确认删除这一行？",
    "admin.error.load": "无法加载维护数据。",
    "admin.error.save": "无法保存这一行。",
    "admin.error.delete": "无法删除这一行。",
    "admin.sections.referenceData": "基础资料",
    "admin.sections.priceMaintenance": "价格维护",
    "admin.sections.uncategorized": "其他",
    "admin.resources.borders": "口岸",
    "admin.resources.destinations": "目的站",
    "admin.resources.railPublicQuotes": "铁路公共报价",
    "admin.resources.railRules": "铁路规则",
    "admin.resources.freightPrices": "铁路运费",
    "admin.resources.leasePickups": "租箱提箱地",
    "admin.resources.leasePrices": "租箱价格",
    "admin.resources.leaseRules": "租箱规则",
    "admin.fields.id": "ID",
    "admin.fields.code": "编码",
    "admin.fields.nameCn": "中文名",
    "admin.fields.nameEn": "英文名",
    "admin.fields.sortOrder": "排序",
    "admin.fields.enabled": "启用",
    "admin.fields.stationCode": "站编",
    "admin.fields.borderCode": "口岸编码",
    "admin.fields.destinationStationCode": "目的站站编",
    "admin.fields.containerSize": "箱型",
    "admin.fields.socPriceUsd": "SOC 最终价 USD",
    "admin.fields.cocPriceUsd": "COC 最终价 USD",
    "admin.fields.quoteUsd": "报价 USD",
    "admin.fields.ownership": "箱属",
    "admin.fields.ruleType": "规则类型",
    "admin.fields.adjustmentUsd": "调整 USD",
    "admin.fields.fixedUsd": "固定价 USD",
    "admin.fields.ruleKey": "界面文案键",
    "admin.fields.priority": "优先级",
    "admin.fields.note": "备注",
    "admin.fields.pickupCode": "提箱地编码",
    "admin.fields.priceUsd": "表价 USD",
    "admin.fields.discountUsd": "折扣金额 USD",
    "admin.fields.displayPriceUsd": "最终显示价 USD",
    "admin.error.leasePriceFormula": "折扣金额和最终显示价不能小于 0，且必须满足：最终显示价 = 表价 - 折扣金额。",
  },
};
