...
assert.match(html, /styles\.css\?v=20260813-rail-quote-rule-fallback/);
assert.match(html, /app\.js\?v=20260813-rail-quote-rule-fallback/);
...
assert.match(css, /\.content-header/);
...
assert.match(app, /\.\/i18n\.js\?v=20260813-rail-quote-rule-fallback/);
assert.match(app, /\.\/calculator\.js\?v=20260813-rail-quote-rule-fallback/);
assert.match(app, /\.\/admin\.js\?v=20260813-rail-quote-rule-fallback/);
