...
assert.match(html, /styles\.css\?v=20260813-rail-ownership-quotes/);
assert.match(html, /app\.js\?v=20260813-rail-ownership-quotes/);
...
assert.match(app, /\.\/i18n\.js\?v=20260813-rail-ownership-quotes/);
assert.match(app, /\.\/calculator\.js\?v=20260813-rail-ownership-quotes/);
assert.match(app, /\.\/admin\.js\?v=20260813-rail-ownership-quotes/);
