...
assert.match(html, /styles\.css\?v=20260811-rail-admin-sidebar/);
assert.match(html, /app\.js\?v=20260811-rail-admin-sidebar/);
...
assert.match(app, /\.\/i18n\.js\?v=20260811-rail-admin-sidebar/);
assert.match(app, /\.\/calculator\.js\?v=20260811-rail-admin-sidebar/);
assert.match(app, /\.\/admin\.js\?v=20260811-rail-admin-sidebar/);
