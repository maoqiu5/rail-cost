...
assert.match(html, /styles\.css\?v=20260811-admin-reference-labels/);
assert.match(html, /app\.js\?v=20260811-admin-reference-labels/);
...
assert.match(app, /\.\/i18n\.js\?v=20260811-admin-reference-labels/);
assert.match(app, /\.\/calculator\.js\?v=20260811-admin-reference-labels/);
assert.match(app, /\.\/admin\.js\?v=20260811-admin-reference-labels/);
